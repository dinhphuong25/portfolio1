        ...
        <div className="p-3 border-t border-slate-100 dark:border-slate-800 flex flex-col gap-2">
          <div className="flex flex-col bg-slate-100/80 dark:bg-slate-800/80 p-1 rounded-xl gap-0.5 relative border border-slate-200/60 dark:border-slate-700/60">
            <button
              ...
              className={`w-full relative flex items-center gap-2.5 py-1.5 px-2.5 text-[11px] font-bold rounded-lg transition-colors duration-200 z-10 ${
                language === "vi"
                  ? "text-slate-900 dark:text-white"
          ...
          <button
            ...
            className="w-full px-3 py-2 text-xs font-semibold text-white dark:text-slate-900 bg-slate-900 hover:bg-slate-800 dark:bg-slate-100 dark:hover:bg-white rounded-xl transition-all flex items-center justify-center gap-1.5 shadow-2xs cursor-pointer"
