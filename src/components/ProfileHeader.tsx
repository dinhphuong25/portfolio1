            ...
            <div className="max-w-2xl mx-auto flex flex-col items-center text-center relative z-10">
                ...
                >
                    ...
                    <div className="group/verified relative inline-flex items-center">
                        ...
                        {/* Tooltip Popup Box - Compact & Centered */}
                        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1 rounded-lg bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 text-[11px] font-bold whitespace-nowrap shadow-lg border border-slate-700/50 dark:border-slate-300 opacity-0 translate-y-1 group-hover/verified:opacity-100 group-hover/verified:translate-y-0 transition-all duration-200 z-30 pointer-events-none flex items-center gap-1">
