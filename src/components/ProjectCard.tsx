        ...
        >
            ...
            >
                {project.thumbnail ? (
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-6 bg-gradient-to-br from-slate-50 to-slate-100/50 group-hover:bg-slate-100/80 transition-colors duration-500">
                        ...
                        <div className="w-16 h-16 rounded-2xl bg-white shadow-sm border border-slate-100 flex items-center justify-center text-slate-400 group-hover:scale-110 group-hover:text-slate-800 transition-all duration-500 mb-3">
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="space-y-2">
                    <h3 className="text-xl font-bold text-slate-900 tracking-tight leading-snug group-hover:text-slate-700 transition-colors">
                        {project.title}
                    </h3>
